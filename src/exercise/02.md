...
Never be "afraid" to dig in to the source code. At first glance it can be
taunting, but reading up on the source code, over and over again, will
eventually lead to a greater understanding. Remember, whatever library or
framwork it regards, it takes time to understand, and that is OK.
