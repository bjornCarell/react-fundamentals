...
The uppercase in the React Component is needed for Babel to be able to compile
it to JavaScript. If no uppercase, babel will compile it as a string

React.createElement("message", {children: 'Hello World'});

With uppercase we get

React.createElememt(Message, {children: 'Hello World'})
